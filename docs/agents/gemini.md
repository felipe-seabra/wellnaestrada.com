...
- **Core Libraries:** Framer Motion (Premium motion), React Hook Form + Zod (Funnel validation).
- **Architecture:** Next.js Server Actions for lead creation and analytics. Context API for multi-step form state. No global state (Zustand) yet.
