...
export const LifestyleSection = () => {
  return (
    <section className="relative w-full overflow-hidden bg-zinc-900 py-24 sm:py-32">
        ...
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          >
            ...
            <p className="text-zinc-300 text-lg sm:text-xl leading-relaxed text-balance">
              Mais do que um intercâmbio, uma transformação completa de vida através de estratégia, segurança e o estilo de vida que você merece.
            </p>
          </motion.div>
          ...
          >
             ...
             <div className="absolute bottom-6 left-6 right-6 flex justify-between items-end">
                <div className="text-left">
                   <p className="text-white/60 text-xs uppercase tracking-[0.2em] font-bold">Dublin, Ireland</p>
                   <p className="text-white font-serif italic text-lg">The journey begins here.</p>
                </div>
